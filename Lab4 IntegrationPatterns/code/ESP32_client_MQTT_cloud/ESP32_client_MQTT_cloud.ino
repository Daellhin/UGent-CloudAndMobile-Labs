...
const char* mqtt_server = "rabbitmq.database.ilabt.cloudandmobile.ilabt.imec.be";
const int mqtt_server_port = 32712;
const char* mqtt_username = "vhspeybrouck-lorin:speybrouck-lorin";
const char* mqtt_password = "GrqrvL6I";
